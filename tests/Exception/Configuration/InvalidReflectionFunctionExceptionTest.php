...
/**
 * Invalid Reflection Function Exception Test
 */
class InvalidReflectionFunctionExceptionTest extends TestCase {

	/**
	 * @return void
	 */
	public function testConstructor(): void {
		$exception = new InvalidReflectionFunctionException();
